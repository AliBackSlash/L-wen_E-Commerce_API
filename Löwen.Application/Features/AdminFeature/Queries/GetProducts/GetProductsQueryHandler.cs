...
public class GetProductsQueryHandler(IProductService productService,IOptions<PaginationSettings> PSettings ) : ICommandHandler<GetProductsQuery, PagedResult<GetProductsQueryResponse>>
{
