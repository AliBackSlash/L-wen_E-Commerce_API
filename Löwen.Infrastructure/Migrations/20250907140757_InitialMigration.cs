    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    Path = table.Column<string>(type: "varchar", maxLength: 2048, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    Tag = table.Column<string>(type: "varchar", maxLength: 50, nullable: false),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AdminLogs_Products_ProductId",
                table: "AdminLogs",
                column: "ProductId",
                principalTable: "Products",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Products_ProductTags_TagId",
                table: "Products",
                column: "TagId",
