...
using Löwen.Application.Features.ProductFeature.Queries.GetAllMostLovedProductsPaged;
using Löwen.Application.Features.ProductFeature.Queries.GetAllProductPaged;
using Löwen.Application.Features.ProductFeature.Queries.GetAllProductPagedByGender;
using Löwen.Application.Features.ProductFeature.Queries.GetAllProductPagedByName;
